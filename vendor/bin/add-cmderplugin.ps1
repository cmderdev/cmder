...
$bash_shared_profile = $env:CMDER_ROOT + "\config\user_profile.sh"
$bash_shared_aliases = $env:CMDER_ROOT + "\config\user_aliases.sh"

$posh_shared_profile = $env:CMDER_ROOT + "\config\user_profile.ps1"
$posh_shared_aliases = $env:CMDER_ROOT + "\config\user_aliases.ps1"

$cmder_shared_profile = $env:CMDER_ROOT + "\config\user_profile.cmd"
$cmder_shared_aliases = $env:CMDER_ROOT + "\config\user_aliases.cmd"
