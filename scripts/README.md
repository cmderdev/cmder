...
- Build the launcheer and download vendor components.
...
- **pack.ps1**: Packages the built distribution into several distributable archives. Use this to assemble release artifacts (zip/tar, checksums, etc.).
- **update.ps1**: Updates Use this to update what will be bundled by `build.ps1`.
